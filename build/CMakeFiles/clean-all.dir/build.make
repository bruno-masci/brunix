...
CMakeFiles/clean-all:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/home/phrack/osdev/workspace/brunix/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Cleaning all (but make/Cmake's own files)..."
	rm -rf brunix.elf System.map linker.ld
	rm -rf brunix.iso iso brunix.asm
